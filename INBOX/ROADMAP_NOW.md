...
- [DONE][GEMINI] TASK_TEST_CLEANUP_GEMINI: pytest only project tests (avoid site-packages). ETA: same day.
- [DONE][GEMINI] TASK_CARD_GEMINI (Wizytówka): system card GROTA_LUMENA (max 15 lines: goal/arch/status/key files). ETA: next.
...
- [DONE] TASK_PROJECT_INDEX.md (scan projects for README/AGENTS)
